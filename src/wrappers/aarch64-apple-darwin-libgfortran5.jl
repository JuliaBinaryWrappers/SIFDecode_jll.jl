# Autogenerated wrapper script for SIFDecode_jll for aarch64-apple-darwin-libgfortran5
export libsifdecode, sifdecoder_standalone

using CompilerSupportLibraries_jll
JLLWrappers.@generate_wrapper_header("SIFDecode")
JLLWrappers.@declare_library_product(libsifdecode, "@rpath/libsifdecode.dylib")
JLLWrappers.@declare_executable_product(sifdecoder_standalone)
function __init__()
    JLLWrappers.@generate_init_header(CompilerSupportLibraries_jll)
    JLLWrappers.@init_library_product(
        libsifdecode,
        "lib/libsifdecode.dylib",
